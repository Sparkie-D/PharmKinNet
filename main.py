...
def get_args():
    ...
    parser.add_argument('--log-id', type=str, default="0409_compound_test")
    parser.add_argument('--train-path', type=str, default='data/test/compound_test_2000.csv')
    parser.add_argument('--valid-path', type=str, default='data/test/compound_test_2000.csv')
    parser.add_argument('--normalizer-path', type=str, default='log/pretrain/RNN&model_size=XS&log_id=0329/model/normalizer.pkl')
    parser.add_argument('--model-path', type=str, default='log/pretrain/RNN&model_size=XS&log_id=0329/model/models_60.pth')
